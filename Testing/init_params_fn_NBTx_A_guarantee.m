%This version uses the orphan drug parameters discussed in Simulation A of 
%"Can Financial Engineering Cure Cancer" Fagnan et al. 2013
...
function params = init_params_fn_NBTx_A()
	...
	...	%    vmu     			vsigma   vmx    UpFront   			Milestone    		mu       			sigma      max		FutureCostEst
             ...
             2.354733621857371, 0.939,   100,  	2.506648325603443, 	1.253324162801722,  1.573797446769595,  0.785050619780075,      20,    	13;  ...     %PRE
             2.976737648081240, 0.939,   250,  	7.519944976810328, 	3.759972488405164,  2.722501027059631,  0.732114106934504,    50,    	0;  ...     %P1
             3.996945974057142, 0.939,   500,   20.053186604827545,	10.026593302413772, 3.702027419856847,  0.795995957236353,     	120,   	0;   ...     %P2
    ...
    bonds.capital_structure = [0.4 0.15 0.45]; %A1, A2, EQ
    ...
    simu.initial_cash  = 5000;
    
    simu.initial_compounds = [0, 100, 100, 0, 0, 0, 0];
